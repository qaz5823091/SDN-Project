...
var elem = {
    force: d3.layout.force()
        ...
        .on("tick", _tick),
    svg: d3.select("#topology-viewer").append("svg")
        .attr("id", "topology")
        .attr("width", "100%")
        .attr("height", "100%")
        .attr("class", CONF.svg_style),
    console: d3.select("#topology-viewer").append("div")
        .attr("id", "console")
...
elem.update = function () {
    ...
    nodeEnter.append("image")
        .attr("xlink:href", "/static/images/router.svg")
...
function initialize_topology() {
    d3.json(CONF.host + "/v1.0/topology/switches", function(error, switches) {
        d3.json(CONF.host + "/v1.0/topology/links", function(error, links) {
