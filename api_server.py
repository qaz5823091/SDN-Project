...
#app_manager.require_app('ryu.app.project.learning_module_rest')
#app_manager.require_app('ryu.app.project.learning_module_auto')
app_manager.require_app('ryu.app.project.learning_module_auto_rest')
